...
<body>
<header class="ms-header">...</header> <div class="layout-container">
    <aside class="ms-sidebar">...</aside> <main class="ms-content">
        ...
        <div class="tile large-tile">
            <div class="tile-header"><h3>Round Lifecycle Control</h3></div>
            <div class="tile-body">
                ...
                <table>
                    <thead><tr><th>ID</th><th>Name</th><th>Start/End</th><th>Status</th><th>Control</th></tr></thead>
                    <tbody>
                    <?php foreach ($rounds as $r): ?>
                        <tr>
                            ...
                            <td><span class="status-tag status-<?php echo $r['status']; ?>"><?php echo ucfirst($r['status']); ?></span></td>
                            <td>
                                ...
                                <?php if ($r['status'] === 'sealed'): ?>
                                    <form method="POST" style="display:inline;" onsubmit="return confirm('FINAL ALLOCATION. Are you sure?');">
        ...
        <div class="tile large-tile">
            <div class="tile-header"><h3>Live Allocation Monitoring</h3></div>
            <div class="tile-body">
                <table>
                    <thead><tr><th>Department</th><th>Capacity</th><th>Locked</th><th>Remaining</th><th>Cutoff Rank</th></tr></thead>
                    <tbody>
                    <?php foreach ($summary as $s): ?>
                        <tr>
                            ...
                            <td class="stat-<?php echo ($s['base_capacity'] - $s['current_locked'] < 20) ? 'danger' : 'safe'; ?>">
